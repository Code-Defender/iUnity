...
class _VoiceScreenState extends State<VoiceScreen> {
  ...
  final List<Map<String, dynamic>> _trendingConcerns = [
    {
      ...
      "description":
          "Localized price fixing identified at Wyoming corridor hubs.",
      "initialNodes": 128,
    },
    {
      "id": "trend_2",
      ...
      "description":
          "Tier 2 brokers failing to respond after detention claims.",
      "initialNodes": 84,
    },
    {
      "id": "trend_3",
      ...
      "title": "Wait Times: NJ",
      "description":
          "Port Elizabeth terminal 4 reporting 6hr average turn times.",
      "initialNodes": 42,
    },
  ];
  ...
  final List<Map<String, dynamic>> _mockReports = [
    {
      ...
      "description":
          "Identified 45% markup above market average at three independent stops within 50 miles. Coordinated pattern suspected.",
    },
    {
      "id": "mock_report_2",
      "region": "NATIONAL",
      ...
      "description":
          "Load board ghosting during ETA verification. Brokers canceling without penalty after arrival confirmed by ELD.",
    },
    {
      "id": "mock_report_3",
      "region": "PACIFIC",
      ...
      "description":
          "Persistent gate failure at LA Basin port terminals causing unpaid detention exceeding safety thresholds.",
    },
  ];
  ...
  void _verifySignal(
    ...
    setState(() {
      ...
      _localVerificationIncrements[reportId] =
          (_localVerificationIncrements[reportId] ?? 0) + 1;
    });
      ...
      try {
        ...
        if (mounted) {
          setState(() {
            ...
            _localVerificationIncrements[reportId] =
                (_localVerificationIncrements[reportId] ?? 1) - 1;
          });
        }
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
        ...
        return _ReportPatternDialog(
          onReportSubmitted: () {
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(
                content: Text(
                  "Report broadcasted successfully to the iUnity network!",
                ),
                backgroundColor: AppColors.primaryContainer,
              ),
            );
  ...
  Color _getTagBgColor(String tag, ThemeData theme) {
    switch (tag.toUpperCase()) {
      ...
      default:
        return AppColors.border.withValues(alpha: 0.15);
    }
  }
                    ...
                    OutlinedButton(
                      onPressed: () {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text(
                              "Every shared voice adds nodes to our real-time truth map.",
                            ),
                            backgroundColor: AppColors.surfaceContainerHigh,
                          ),
                        );
        ...
        SizedBox(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final activeNodesCount =
                  item["initialNodes"] + (isJoined ? 1 : 0);
        ...
        StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
          ...
          builder: (context, snapshot) {
            ...
            for (int i = 0; i < allReports.length; i++) {
              ...
              if (_selectedRegionFilter == "ALL REGIONS" ||
                  region == _selectedRegionFilter) {
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Expanded(flex: 2, child: bentoCard),
            const SizedBox(width: 20),
            Expanded(flex: 1, child: statsCard),
          ],
        ),
      ],
    );
  ...
  Widget _buildMobileStack(
    ...
    children.add(_buildStatsCard(theme));
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  Icon(severityIcon, color: borderSeverityColor, size: 18),
                ],
              ),
              const SizedBox(height: 12),
              Text(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () =>
                          _verifySignal(reportId, isMock, docRef: docRef),
                    ...
                    InkWell(
                      onTap: () {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text(
                              "Findings copied to secure clipboard.",
                            ),
                            backgroundColor: AppColors.primaryContainer,
                          ),
                        );
                    ...
                    InkWell(
                      onTap: () {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text(
                              "Drafting Collective Arbitration petition...",
                            ),
                            backgroundColor: AppColors.primaryContainer,
                          ),
                        );
  ...
  void _submit() async {
    ...
    try {
      ...
      await _databaseService
          .addDocument(collectionPath: 'reports', data: reportData)
